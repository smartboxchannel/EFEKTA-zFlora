...
const definition = {
        ...
        fromZigbee: [fz.temperature, fz.humidity, fz.soil_moisture, fz.battery, fzLocal.node_config, fzLocal.temperaturef_config, fzLocal.node_debug, fzLocal.uptime],
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
			...
			const overrides5 = {min: 600, max: 7200, change: 100};
